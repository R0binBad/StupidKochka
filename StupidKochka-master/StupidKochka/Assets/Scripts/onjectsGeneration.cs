...
public class onjectsGeneration : MonoBehaviour
{
    ...
    public void Init()
    {
        ...
        scene = new List<Prefab>();
            prefab = new Prefab(Cock, new Vector3((float)13.11, (float)3.4, (float)-5.839844));
            scene.Add(prefab);
            prefab = new Prefab(Protein, new Vector3((float)17.41, (float)1.4, (float)-5.839844));
            scene.Add(prefab);
            prefab = new Prefab(Bottle, new Vector3((float)23.6, (float)-1.48, (float)-5.839844));
            scene.Add(prefab);
            prefab = new Prefab(Cock, new Vector3((float)28.76, (float)3.4, (float)-5.839844));
            scene.Add(prefab);
        scenes.Add(scene);
        ...
        scene = new List<Prefab>();
            ...
            scene.Add(prefab);
            prefab = new Prefab(Cock, new Vector3((float)21.01, (float)3.99, (float)-5.839844));
            scene.Add(prefab);
        ...
        scene = new List<Prefab>();
            ...
            scene.Add(prefab);
            prefab = new Prefab(Cock, new Vector3((float)29.03, (float)3.99, (float)-5.839844));
            scene.Add(prefab);
        scenes.Add(scene);
        ...
        scene = new List<Prefab>();
            ...
            scene.Add(prefab);
            prefab = new Prefab(Cock, new Vector3((float)31.07, (float)3.99, (float)-5.839844));
            scene.Add(prefab);
        scenes.Add(scene);
    }
}
